function returnBreweriesInfo(searchCity) {
  var queryURL =
    "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=breweries&location=" +
    searchCity +
    "&limit=10&sortby=distance";
  ...
  $.ajax({
    ...
    //Display in console log the region center latitude and longitude
  ...
  function breweryInfo(brewery) {
    ...
    var infoReviews =
      "Yelp Review: " + localStorage.getItem("reviews" + brewery);
